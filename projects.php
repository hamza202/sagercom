...
<div id="rs-project" class="rs-project project-style-2 sec-spacer">
    <div class="container-fluid">
        <div class="project-filter">
            <button class="active" data-filter="*">جميع المشاريع</button>
            <button data-filter=".filter1">فنادق</button>
            <button data-filter=".filter2">منازل</button>
            <button data-filter=".filter3">فيلا</button>
            <button data-filter=".filter4">اخرى</button>
        </div>
        <div class="row">
